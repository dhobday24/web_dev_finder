...
urlpatterns = [
    ...
    url(r'^job_posts/(?P<job_id>[0-9]+)/$', views.long_description_job, name = 'long_description_job'),
    url(r'^talent_ads/(?P<ad_id>[0-9]+)/$', views.long_description_musad, name = 'long_description_musad')
