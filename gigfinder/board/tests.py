...
class gigfinderTests(TestCase):
    ...
    def test_board(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertContains(
            response, '<a href="/board/events">Events Board</a>', status_code=200, html=True)
        self.assertContains(
            response, '<a href="/board/job_posts">Open Jobs</a>', status_code=200, html=True)
        self.assertContains(
            response, '<a href="/board/talent_ads">Talent Ads</a>', status_code=200, html=True)
    ...
    def test_event(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertContains(
            response, '<a href="/board">Go Back to Boards</a>', status_code=200, html=True)
...
class EventTestCase(unittest.TestCase):
    ...
    def test_event(self):
        ...
        self.assertEquals(self.event1.event_description_short,
                          'short description of the event')
        self.assertEquals(self.event1.event_description_long,
                          'long description of the event test')
...
class Job_PostingTestCase(unittest.TestCase):
    ...
    def test_job_posting(self):
        ...
        self.assertEquals(self.JobPosting.job_description_short,
                          'short job description')
        self.assertEquals(self.JobPosting.job_description_long,
                          'long job description')
        self.assertEquals(self.JobPosting.pub_date,
                          datetime.date(2016, 11, 11))
        self.assertEquals(self.JobPosting.start_date,
                          datetime.date(2016, 11, 11))
        self.assertEquals(self.JobPosting.end_date,
...
class Musician_adTestCase(unittest.TestCase):
    ...
    def test_musician_ads(self):
        ...
        self.assertEquals(
            self.musicians_ads.ad_description_short, 'short ad description')
        self.assertEquals(
            self.musicians_ads.ad_description_long, 'long ad description')
        self.assertEquals(self.musicians_ads.pub_date,
                          datetime.date(2016, 11, 11))
        self.assertEquals(self.musicians_ads.start_availability,
                          datetime.date(2017, 1, 1))
        self.assertEquals(self.musicians_ads.end_availability,
